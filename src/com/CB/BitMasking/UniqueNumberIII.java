...
public class UniqueNumberIII {
    /*
     Given an array containing n numbers in which all the numbers are present thrice
     except for one number which is only present once. we have to find that unique number.
     */
